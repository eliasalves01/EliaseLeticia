...
const fileFilter = (req, file, cb) => {
  // Aceitar apenas jpg, jpeg, png e gif
...
// Configurar multer com nossas configurações
const upload = multer({ 
  storage: storage,
...
// Rota para salvar banco de dados de imagens
...
app.post('/api/upload', (req, res, next) => {
  ...
  try {
    ...
    // Preparar dados da imagem para salvar no "banco de dados"
    const imageData = {
      id: path.parse(req.file.filename).name, // UUID sem extensão
